...
def test_rms():
    ...
    assert_almost_equal(rms(x, axis=0), np.array([5.0990195, 9., 5.1478150, 11.0453610, 0.]))
...
def test_crestfactor():
    ...
    assert_almost_equal(crestfactor(x, axis=0), np.array([0.3922321, 0., 0.9712856, 0.18107148, 0.]))
